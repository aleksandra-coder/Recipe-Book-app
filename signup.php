      ...
      <div class="col-lg-4">
         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">  <!-- returns the filename of the currently executing script and converts special characters to HTML entities -->
            <div class="form-group">
               ...
               <span class="error"><?php echo $username_err;?></span>  <!-- show error message -->
            </div>
            <div class="form-group">
               <label>Password</label><input type="password" class="form-control" name="password" id="password" value="<?php echo $password;?>">
               <span class="error"><?php echo $password_err;?></span>  <!-- show error message -->
            </div>
            <div class="form-group">
               ...
               <span class="error"><?php echo $confirm_password_err;?></span>  <!-- show error message -->
            </div>
