...
$conn->query($sql); //action to delete a record from recipe table 
   ...
   <div class="row justify-content-around">
      <div class="col-lg-6">
         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <!-- returns the filename of the currently executing script and converts special characters to HTML entities -->
