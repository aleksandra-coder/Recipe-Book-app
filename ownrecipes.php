...
$activeUser = $_SESSION['userID']; //variable for checking which user is active

$sql = "SELECT * FROM recipe  WHERE userID='$activeUser' ORDER BY RecipeName;"; //select all the data from recipe table that is added by the active user
...
<div class="container">
   ...
   <div class="row">
      <div class="card-deck">
         <?php while ($row = mysqli_fetch_array($result)){ ?> <!-- while loop for printing all rows from the table -->
            ...
            <div class="card">
               ...
               <?php  
                  if ( is_file (RECIPE_UPLOAD_PATH . $row['Images']) && filesize (RECIPE_UPLOAD_PATH . $row['Images']) > 0 ) {
                     ...
                     echo '<img class="card-img-top" src=" ' . RECIPE_UPLOAD_PATH . 'noimage.jpg' . '" alt=" " />';
                  } 
               ?>
               <div class="card-body">
                  <h5 class="card-title"><?php echo $row['RecipeName']; ?></h5> <!-- displays the name of a recipe -->
                  <h6 class="card-subtitle mb-2 text-muted">
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                     <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                  </svg> <?php echo $row['Servings']; ?> <!-- displays the amount of servings of a recipe -->
                  ...
                  </svg> <?php echo $row['PreparationTime']; ?> min <!-- displays the preparation time of a recipe -->
                
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-star" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                     <path fill-rule="evenodd" d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.523-3.356c.329-.314.158-.888-.283-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767l-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288l1.847-3.658 1.846 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.564.564 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
                  </svg> <?php echo $row['Ratings']; ?> <!-- displays the rating of a recipe -->
                  </h6>  
                  <ul class="list-group list-group-flush">
                     <h5>Ingredients</h5>
                     <li class="list-group-item"><?php echo $row ['Ingredients']; ?> </li> <!-- displays the ingredients of a recipe -->
                  </ul>
                  <h5>Instructions</h5>
                  <p class="card-text"> <?php echo $row ['Instructions']; ?></p> <!-- displays the instructions of a recipe -->
